...
project = "camsort"
copyright = "2024, matthewb96"
author = "matthewb96"

# Third Party
import camsort

version = str(camsort.__version__)
release = version
...
modindex_common_prefix = ["camsort."]
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/matthewb96/camsort",
    ...
    "external_links": [
        {
            "name": "Changelog",
            "url": "https://github.com/matthewb96/camsort/releases",
        },
        {
            "name": "Issues",
            "url": "https://github.com/matthewb96/camsort/issues",
        },
    ],
